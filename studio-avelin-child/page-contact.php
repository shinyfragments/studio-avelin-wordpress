...
<body <?php body_class( array( 'sa-front', 'sa-page', 'sa-page--contact' ) ); ?>>
<?php wp_body_open(); ?>
...
<main class="sa-main" id="sa-main">
	<div class="sa-shell">
		...
		<section class="sa-phero sa-reveal">
			...
			<h1 class="sa-phero__h"><?php echo wp_kses_post( 'Erzähl mir von <span class="sa-lime-text">deinem Projekt</span>.' ); ?></h1>
			<p class="sa-phero__lede">
				Eine grobe Idee reicht für den Anfang. Ich lese jede Anfrage selbst und melde mich
				persönlich bei dir – in der Regel innerhalb von zwei Werktagen.
			</p>
		</section>
		...
		<section class="sa-section" aria-labelledby="sa-contact-form-title">
			<h2 class="sa-sec-title sa-reveal" id="sa-contact-form-title">Kurz das Wichtigste – den Rest klären wir im Gespräch.</h2>

			<div class="sa-contact-page__layout sa-reveal">
				...
				<aside class="sa-contact-page__aside">
					<span class="sa-sec-kicker">Lieber direkt?</span>
